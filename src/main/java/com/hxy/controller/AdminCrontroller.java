...
import com.hxy.entity.vo.BlogModifyModel;
import com.hxy.entity.vo.ResumeModifyModel;
...
/**
 * @author hexy
 * @date 2018/12/1414:40
 */
@Controller
@RequestMapping("/admin")
public class AdminCrontroller  extends BaseController {
    @Autowired
